...
<p>all category levels separated by configurable tree separator , defaulting to /</p>
...
<div class="fieldinfo">this enable you to import the categories prepending a base root tree to the values found in csv (use same syntax as described above)<br/>
<b>IMPORTANT , use tree level separator defined above in case of multilevel base tree</b></div>
</div>
<div class="formline">
