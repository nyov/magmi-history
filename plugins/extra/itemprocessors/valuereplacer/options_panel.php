...
<div class="fieldinfo">
	...
	<ul>
		...
		<li>with sku in the list of replaced fields, if xxx-{item.sku} for replacing value , the sku inserted will be xxx-sku0</li>
		<li>you can put any number of {item.[some item field]} references in the replacing value</li>
	</ul>
	<hr/>
	<ul>
		<li><b>Expression examples:</b></li>
		<li>lets say you want to calculate cost from cost &amp; margin</li>
		<li>just put {{ {item.cost}*(1+({item.margin}/100)) }} in the replaced value for price</li>
	</ul>
	<hr/>
	<ul>
